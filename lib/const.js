module.exports = {
  ...
  /** @const {Number} ADDRESSES_BATCH_SIZEX - Max batch size of addresses for each getBalance */ 
  ...
  /** @const {String} ACCOUNT_INDEX_KEY - Redis prefix for the account index counters */
  ...
  /** @const {String} HOT_WALLET_INDEX_KEY - Redis prefix for the hotwallet index counter */
