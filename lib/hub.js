...
class Hub extends EventEmitter {
  ...
  async createHotWalletInput(checksum = true) {
    ...
    const save = await this[store].rpush(constants.HOT_WALLET_INPUTS_PREFIX, '', hotWalletInput);
  ...
  async getDepositAddress(hubId, accountId, checksum = true) {
    ...
    if (accountIndex === constants.MAX_ADDRESSES) {
      console.log(`Your customer with account id #${accountId} managed to consume ${constnats.MAX_ADDRESSES}. What a dumbass!`);
      return false;
    }
