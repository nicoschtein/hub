...
class redisAdapter {
  ...
  constructor(options) {
    ...
    this.client = client;
    this.multi = client.multi.bind(client);
  ...
  getset(prefix, key, obj) {
    
    const value = JSON.stringify(obj);
    
    return new Promise((resolve) => {

      this.client.getset(prefix + key.toString(), value, (err, prev) => {
  ...
  decr(prefix, key) {
    ...
    return new Promise((resolve) => {
      ...
      this.client.decr(prefix + key.toString(), (err, value) => {
  ...
  lset(prefix, key, index, obj) {
    
    return new Promise((resolve) => {
    
      this.client.lset(prefix + key.toString(), index, JSON.stringify(obj));
  ...
  lrem(prefix, key, obj) {
    ...
    return new Promise((resolve) => {
      ...
      this.client.lrem(prefix + key.toString(), 0, JSON.stringify(obj));
